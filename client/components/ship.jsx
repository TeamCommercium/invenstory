...
export default (props) =>
  ...
  <Dialog active={props.active}>
    ...
    <Slider className="styles__detailSlider___317hh" snaps={true} pinned={false} min={0} max={props.data.quantity} step={1} editable value={props.ship_quantity || 0} onChange={props.handleQuantityChange.bind(this)} />
    <Button 
      className="styles__inlineButton___16AEc" label='Cancel' raised floating onMouseUp={props.handleShipModal.bind(this)}
    />
    <Button className="styles__detailButton___1aYnt" label='Ship' raised floating primary onMouseUp={props.confirmShip.bind(null, props.data.id, props.data.seller_sku, props.data.amzn_price_fba || props.data.amzn_price_fbm)} />
